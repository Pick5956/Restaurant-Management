        ...
        <div className="px-4 py-2 sm:px-6 lg:px-8 lg:pb-2 lg:pt-4">
          ...
          <div className="relative shrink-0">
            ...
            {moreOpen && (
              <>
                ...
                <div
                  role="menu"
                  className={`${moreClosing ? "smooth-pop-exit" : "smooth-pop"} absolute right-0 top-full z-50 mt-2 w-56 origin-top-right overflow-hidden rounded-xl border border-slate-200 bg-white py-1 text-left shadow-(--dashboard-control-shadow) dark:border-gray-800 dark:bg-gray-900`}
                >
                  <button
                    type="button"
                    role="menuitem"
          ...
          {canManage && (
            <button
              type="button"
              onClick={openCreate}
              className="inline-flex h-9 shrink-0 items-center justify-center gap-1.5 rounded-xl bg-orange-700 px-3 text-[12px] font-semibold text-white shadow-(--dashboard-control-shadow) transition hover:bg-orange-800 dark:bg-orange-700 dark:text-white"
            >
