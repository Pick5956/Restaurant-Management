// Google's four-colour "G", drawn from Google's sign-in branding. Shared by the
// sign-in modal and the account settings page so the two cannot drift apart.
export default function GoogleGlyph({ className = "h-[18px] w-[18px]" }: { className?: string }) {
  return (
    <svg viewBox="0 0 18 18" className={`${className} shrink-0`} aria-hidden="true" focusable="false">
