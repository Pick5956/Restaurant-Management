...
export default function KitchenScreen() {
  ...
  if (!canView) {
    return <AppScreen title={copy('ครัว', 'Kitchen')}><EmptyState title={copy('ไม่มีสิทธิ์ดูคิวครัว', 'No permission to view the kitchen queue')} detail={copy('ต้องมีสิทธิ์ view_kitchen', 'The view_kitchen permission is required.')} /></AppScreen>;
  }
