export type ManagerReport = {
  ...
  summary: { orders: number; gross_revenue?: number; discount?: number; expenses?: number; expense_count?: number; revenue: number; cost: number; profit: number; margin: number };
};
