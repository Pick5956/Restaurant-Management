...
- **คำสั่งที่ผู้ใช้พิมพ์ซ้ำ ก็ยังเป็นคำสั่ง ต้องส่งมาทุกครั้ง** แม้ในบทสนทนาจะมีคำสั่งเดียวกันอยู่แล้ว
  (เขายกเลิกการ์ดเดิม การ์ดหมดอายุ หรือกด "ขอคำสั่งใหม่") ห้ามตอบ [] เพราะเห็นว่าเคยสั่งไปแล้ว
  ระบบรู้เองว่ามีรายการค้างอยู่หรือไม่ ถ้าตอบ [] เจ้าของจะได้คำตอบลอย ๆ แทนการ์ด
